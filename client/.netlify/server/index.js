...
var __defNormalProp = (obj, key2, value) =>
	key2 in obj
		? __defProp2(obj, key2, { enumerable: true, configurable: true, writable: true, value })
		: (obj[key2] = value);
...
${
	components[1]
		? `${(0, import_index_829c628b.v)(
				components[0] || import_index_829c628b.m,
				'svelte:component'
		  ).$$render(
				$$result,
				...
				{},
				{
					default: () => {
						return `${
							components[2]
								? `${(0, import_index_829c628b.v)(
										components[1] || import_index_829c628b.m,
										'svelte:component'
								  ).$$render(
										$$result,
										...
										{
											default: () => {
												return `${(0, import_index_829c628b.v)(
													components[2] || import_index_829c628b.m,
													'svelte:component'
...
async function load_node({
			...
			fetch: async (resource, opts = {}) => {
				...
				if (is_asset || is_asset_html) {
					...
					response = await respond(
						new Request(new URL(requested, event.url).href, __spreadValues({}, opts)),
						options,
	...
	return {
		...
		set_cookie_headers: new_cookies.map((new_cookie) => {
			const _a2 = new_cookie,
				{ name, value } = _a2,
				options2 = __objRest(_a2, ['name', 'value']);
	...
	async respond(request, options = {}) {
		...
		if (!this.options.hooks) {
			const module2 = await Promise.resolve().then(() =>
				__toESM(require('./chunks/hooks-1c45ba0b.js'))
			);
			this.options.hooks = {
