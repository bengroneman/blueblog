...
const Hero = (0, import_index_829c628b.c)(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${'relative my-12'}"><div class="${'mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left'}"><div class="${'px-4 lg:w-1/2 sm:px-8 xl:pr-16'}">${
		content.attributes
			? `<h1 class="${'text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl'}"><span class="${'block xl:inline'}">${(0,
			  import_index_829c628b.b)(content.attributes.hero.title)}</span></h1>`
			: ``
	}
...
const Routes = (0, import_index_829c628b.c)(($$result, $$props, $$bindings, slots) => {
	let heroContent = {};
	return `${(0, import_index_829c628b.v)(Hero, 'Hero').$$render(
		$$result,
		{ content: heroContent },
		{},
		{}
...
${(0, import_index_829c628b.v)(import_ArticleShowcase_72d64028.A, 'ArticleShowcase').$$render(
	$$result,
	{},
	{},
	{}
