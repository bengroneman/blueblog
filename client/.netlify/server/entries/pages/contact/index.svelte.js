...
const Contact = (0, import_index_829c628b.c)(($$result, $$props, $$bindings, slots) => {
  return `
<div class="${"relative bg-white"}"><div class="${"absolute inset-0"}"><div class="${"absolute inset-y-0 left-0 w-1/2 bg-gray-50"}"></div></div>
	<div class="${"relative max-w-7xl mx-auto lg:grid lg:grid-cols-5"}"><div class="${"bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12"}"><div class="${"max-w-lg mx-auto"}"><h2 class="${"text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl"}">Get in touch
				</h2>
				...
				<dl class="${"mt-8 text-base text-gray-500"}"><div><dt class="${"sr-only"}">Postal address</dt>
						<dd><p>742 Evergreen Terrace</p>
							<p>Springfield, OR 12345</p></dd>
					</div><div class="${"mt-6"}"><dt class="${"sr-only"}">Phone number</dt>
						<dd class="${"flex"}">
							...
							<span class="${"ml-3"}">+1 (555) 123-4567 </span></dd>
						...
						<dd class="${"flex"}">
							...
							<span class="${"ml-3"}">support@example.com </span></dd></div></dl>
				<p class="${"mt-6 text-base text-gray-500"}">Looking for careers?
